    ...
    $menu = '
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="./">
                <img class="d-inline-block align-top-left" width="30" height="30" src="./Images/logo.png" aria-label="Logo compagnie" /> Crazy Cupcakes
            </a>
...
function IsActive($url)
{
    ...
    return strcasecmp($url, $pageName) == 0 ? "active" : ""; //strcasecmp   fonction qui compare si deux chaînes sont égales: en ignorant la case. Elle retourne 0 si les chaînes sont égales.
}
?>